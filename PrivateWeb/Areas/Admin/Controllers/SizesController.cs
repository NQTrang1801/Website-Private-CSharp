...
namespace PrivateWeb.Areas.Admin.Controllers
{
    ...
    public class SizesController : Controller
    {
        ...
        public SizesController(PrivateWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Sizes != null ? 
                          ...
                          Problem("Entity set 'PrivateWebContext.Sizes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreatedAt,UpdatedAt")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CreatedAt,UpdatedAt")] Size size)
        {
            if (id != size.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PrivateWebContext.Sizes'  is null.");
            }
            var size = await _context.Sizes.FindAsync(id);
            if (size != null)
            {
