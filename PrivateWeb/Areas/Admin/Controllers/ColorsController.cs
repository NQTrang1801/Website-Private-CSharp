...
namespace PrivateWeb.Areas.Admin.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public ColorsController(PrivateWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Colors != null ? 
                          ...
                          Problem("Entity set 'PrivateWebContext.Colors'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code,CreatedAt,UpdatedAt")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code,CreatedAt,UpdatedAt")] Color color)
        {
            if (id != color.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PrivateWebContext.Colors'  is null.");
            }
            var color = await _context.Colors.FindAsync(id);
            if (color != null)
            {
