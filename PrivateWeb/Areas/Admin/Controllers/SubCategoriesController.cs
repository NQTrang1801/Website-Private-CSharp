    ...
    public class SubCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.SubCategories != null ? 
                          ...
                          Problem("Entity set 'PrivateWebContext.SubCategories'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Slug,Status,Image,CategoryId,CreatedAt,UpdatedAt,IsFeatured,ShowHome")] SubCategory subCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Slug,Status,Image,CategoryId,CreatedAt,UpdatedAt,IsFeatured,ShowHome")] SubCategory subCategory)
        {
