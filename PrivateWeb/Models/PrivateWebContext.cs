	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity<Product>(entity =>
		{
			...
			entity.HasOne(d => d.Category).WithMany(p => p.Products)
				...
				.HasConstraintName("FK__products__category__6A30C649");

			entity.HasOne(d => d.Images).WithMany(p => p.Products)
				.HasForeignKey(d => d.ImagesId)
				.HasConstraintName("FK__products__images___693CA210");

			entity.HasOne(d => d.Promotion).WithMany(p => p.Products)
				.HasForeignKey(d => d.PromotionId)
				.HasConstraintName("FK__products__promo__6B24EA82");

			entity.HasOne(d => d.SubCategory).WithMany(p => p.Products)
				.HasForeignKey(d => d.SubCategoryId)
				.HasConstraintName("FK__products__subcate__68487DD7");
		});
		...
		modelBuilder.Entity<SubCategory>(entity =>
		{
			...
			entity.HasOne(d => d.Category).WithMany(p => p.SubCategories)
				...
				.HasConstraintName("FK__subcate__category__6A30C649");
		});
		...
		modelBuilder.Entity<Variantss>(entity =>
		{
			...
			entity.HasIndex(e => e.ColorId, "IX_variantss_color_id");

			entity.HasIndex(e => e.PromotionId, "IX_variantss_promotion_id");

			entity.HasIndex(e => e.SizeId, "IX_variantss_size_id");
